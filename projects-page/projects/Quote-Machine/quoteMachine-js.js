...
var quoteInsert = document.getElementById("quoteInsert");
var btns = document.getElementById("newQuote");
  ...
  $(btns).on('click', function(){
    quoteInsert.innerHTML = '"' + getQuote(ronSwansonQuotes);
  });
  
  $("#tweet").click(function(){
    $(".twitter-share-button").attr("href", 'https://twitter.com/intent/tweet?text=' + getQuote(ronSwansonQuotes));
    });
  
  
function getQuote(object){
  var quote;
    
  quote = object[Math.floor(Math.random() * (object.length - 0)) + 0];
  return quote;
  }
 
  
function randomColors(sure){
